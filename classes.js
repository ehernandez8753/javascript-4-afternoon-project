...
let newManager = new Manager("John", "Wick", "john@mail.com", 12);
console.log(newManager);
let newProgMang = new ProgressiveManager("Bill", "Murray", "@bill@mail.com", 13, []);
console.log(newProgMang);
...
class Machine{
  ...
  makeWidgets(numberToMake){
    this.widgets_made_count += numberToMake;
    this.wear_and_tear_count += Math.floor(numberToMake/50);
  }
  fixMachine(){
